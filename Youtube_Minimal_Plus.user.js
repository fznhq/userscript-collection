...
(function () {
    ...
    function initCSS() {
        ...
        css.textContent = /* css */ `
            ...
            .logo-full { width: 200px; margin-bottom: 20px; color: var(--yt-spec-wordmark-text); }
